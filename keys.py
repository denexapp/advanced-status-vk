...
# Replace YOUR_APP_ID by your app id and open link
# https://oauth.vk.com/authorize?client_id=YOUR_APP_ID&redirect_uri=https://oauth.vk.com/blank.html&scope=offline%2Cstatus&response_type=token&v=5.73
# Grab access token from address bar
